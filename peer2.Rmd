...
## Plot with Plotly
Maximum wind speed for hourly observations made between March 3rd and April 18th of 2014 near Halifax Harbour. The maximum wind speed are plotted in a polar chart and are ledgened with Beaufort description of the wind speed.
...
p2  <- plot_ly(max_wind, r = ~wind, t = ~direction,color = ~beaufortChar) %>%
        layout(radialaxis = list(ticksuffix = "m/s"), orientation = 270,title = "Maximum Wind speed in Halifax and correlating Beauford Description" )
p2
```
